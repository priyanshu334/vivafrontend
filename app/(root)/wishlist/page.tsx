    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="text-center">
          <Button className="px-12 py-3 bg-[#b36985] hover:bg-[#a25877] text-white rounded-full font-medium text-base shadow-md hover:shadow-lg transition-all duration-200">
            Show More
          </Button>
        </div>
      </div>
