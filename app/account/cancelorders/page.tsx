        ...
        <Card className="border mb-6">
          <CardContent className="flex flex-col items-center py-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button className="bg-[#089313] text-white rounded-md px-6 py-2 text-sm font-medium shadow hover:bg-green-700 transition">
                Cancel Order
              </button>
              <button className="bg-white text-gray-700 border border-gray-300 rounded-md px-6 py-2 text-sm font-medium shadow hover:bg-gray-50 transition">
                Update Order
              </button>
            </div>

            {/* Return Policy */}
            <div className="mt-6 text-sm bg-gray-100 w-full px-4 py-2 border border-gray-200 text-center">
